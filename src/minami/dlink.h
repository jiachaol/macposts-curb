...
public:
  ...
  virtual int evolve(TInt timestamp, TFlt ratio_lane_closure) {return 0;};

  // Jiachao added in Aug 29: curb-link evolve function
  virtual int evolve_curb(TInt timestamp) {return 0;};

  virtual int evolve_control(TInt timestamp, TFlt ratio_lane_closure, TFlt cell_position, TFlt cell_control_rate) {return 0;}

  virtual TFlt get_link_supply() {return TFlt(0);};
  virtual TFlt get_link_capacity() {return TFlt(0);};
  virtual int clear_incoming_array(TInt timestamp, TFlt ratio_lane_closure) {return 0;};
  ...
  virtual TInt get_link_freeflow_tt_loading() {return TInt(-1);};
...
public:
  ...
  virtual int evolve(TInt timestamp, TFlt ratio_lane_closure) override;
  // virtual int evolve_control(TInt timestamp, TFlt ratio_lane_closure, TFlt cell_position, TFlt cell_control_rate) {return 0;}

  virtual TFlt get_link_supply() override;
  virtual TFlt get_link_capacity() override;
  virtual int clear_incoming_array(TInt timestamp, TFlt ratio_lane_closure) override;
