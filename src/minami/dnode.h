...
public:
  ...
  virtual int evolve_control(TInt timestamp, std::unordered_map<std::string, float> *control_map, std::unordered_map<std::string, std::vector<float>> *control_map_list, std::unordered_map<TInt, std::vector<TInt>> *lane_closure_map){return 0;};
