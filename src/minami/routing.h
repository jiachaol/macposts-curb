...
public:
  ...
  // Jiachao added in Oct. for curb
  virtual int init_routing_curb(Path_Table *path_table_car=nullptr, Path_Table *path_table_truck=nullptr, Path_Table *path_table_rh=nullptr){return 0;};
...
public:
  ...
  virtual int init_routing_curb(Path_Table *path_table_car=NULL, Path_Table *path_table_truck=NULL, Path_Table *path_table_rh=NULL) override;
